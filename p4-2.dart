...
bool checkConditions({
  ...
  bool condition2 =
      optionalIntegers?.every((element) => element.isEven) ?? true;
...
void main() {
  // Example usage
  bool result1 = checkConditions(
      requiredString: "abc", namedInteger: 2, optionalIntegers: [2, 4, 6]);
  print('Result 1: $result1');

  bool result2 = checkConditions(
      requiredString: "abc", namedInteger: 4, optionalIntegers: [1, 2, 3]);
